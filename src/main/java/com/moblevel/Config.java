...
public class Config {
    ...
    public static final ForgeConfigSpec.DoubleValue HOSTILE_HIGH_LEVEL_CHANCE = BUILDER
    ...
    public static final ForgeConfigSpec.DoubleValue HOSTILE_LEVEL_RARITY_EXPONENT = BUILDER
    ...
    public static final ForgeConfigSpec.DoubleValue COMMON_LEVEL_SKEW = BUILDER
